    ...
    <Card className="tech-card p-6 relative">
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        {skills.map((skill, index) => (
          <span
            key={index}
            className="bg-tech-blue/10 text-tech-blue text-xs px-2 py-1 rounded-md border border-tech-blue/20"
          >
            {skill}
          </span>
        ))}
  ...
  const experiences = [
    {
      ...
      location: "Remote",
      description: [
        "Developed a Library Management System with role-based access control",
        "Implemented database integration with MySQL for efficient data management",
        "Designed an intuitive user interface using Java Swing for seamless user experience"
      ],
    ...
    },
    {
      ...
      location: "Remote",
      description: [
        "Created a Land Price Prediction Model achieving 15% improvement in accuracy",
        "Implemented feature selection techniques to enhance model performance",
